      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <Text color="gray.700" mb={4} fontSize="lg" textAlign="center">
              දර්ශන අධ්‍යයන අංශයේ දර්ශනය, මනෝවිද්‍යාව, සාමය හා ගැටුම් නිරාකරණය
              යන උපාධි පාඨමාලාවන් හදාරනු ලබන සාමාන්‍යයවේදී හා විශේෂවේදී
              විද්‍යාර්ථයන්ගේ නිර්මාණශීලීත්වය ඔප් නැංවීම උදෙසා සිදු කරනු ලබන{' '}
              <br></br> E Magazine for Undergraduate විද්‍යුත් සඟරාමය අත්දැකීම
            </Text>
            {/* <Button
              as="a"
